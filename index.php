...
<?php if (isset($_SESSION['customer'])): ?>
  <li class="top_li1"><a href="#">Welcome</a></li>
<?php else: ?>
 <li class="top_li1"><a href="web/">Login</a></li>
<li class="top_li2"><a href="web/">Register</a></li> 
<?php endif ?>
...
<div class="container">
  <a class="navbar-brand" href="index.html"><span class="fa fa-home"></span>My Hao</a>
...
<a href="#"><img src="admin/upload/<?php echo $row['image'] ?>" class="img-fluid" alt=""></a>
