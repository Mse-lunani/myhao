<?php
include 'h.php';
$_SESSION['active'] = 'email_maillist';
include 'topnav.php';
include 'aside.php';
?>
...
<button class="btn btn-primary" data-toggle="modal" data-target="#add">Add email</button>
  </div>
<div class="card-body">
...
<div class="modal fade" id="exists">
...
<div class="modal-body">
<p>That email is already in the database</p>
</div>
...
<div class="modal-dialog">
  <div class="modal-content">
<div class="modal-header">
  <h4 class="modal-title">Add mail to list</h4>
  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
<span aria-hidden="true">&times;</span>
  </button>
</div>
<form method="POST" action="model/add_mail.php">
<div class="modal-body">
<div class="form-group">
<label>Name</label>
